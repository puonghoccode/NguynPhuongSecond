  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex " action="search_product.php" method="get">
        <input class="form-control me-2 text-warning" type="search" placeholder="Search" 
        aria-label="Search">
...
?>
    ...
    <!-- third child -->
<div class="bg-dark">
    <h3 class="text-center text-warning mt-0">Hidden Store</h3>
    <p class="text-center text-light mb-0">Communication is at the heart of e-commerce and community</p>
</div>
